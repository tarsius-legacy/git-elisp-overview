...
+ [[https://github.com/magit/git-modes][git-modes]] various loosely related libraries
  + git-commit-mode (will be replaced by git-commit in magit v2.1.0)
  + git-rebase-mode (will be replaced by git-rebase in magit v2.1.0)
  + gitattributes-mode
  + gitconfig-mode
  + gitignore-mode
...
+ [[https://github.com/tarsius/magit-push-remote][magit-push-remote]] push remote support for Magit
